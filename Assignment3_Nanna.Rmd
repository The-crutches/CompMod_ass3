...
#Takes dataset(MA_d), want to know what kind of effect size (standardized mean difference), number of participant in each group (TD_N and ASD_N), Mean of the variable we are calculating for each group (PitchVariability), and SD for both groups, slab is for plotting? 
